...
export default function Introduction({ isLightOn }: IntroductionProps) {
    return (
        <div className="flex flex-col justify-center items-center ml-4 text-white h-[50vh] w-[28vh] lg:w-[100vh] md:w-[60vh] sm:w-[40vh]">
            ...
            <div
                className="text-center mb-4 text-[clamp(1.5rem,4vw,2.5rem)] font-extrabold leading-[1.1] text-[#EEF1F5]"
                style={{
                    animation: "slideInUp 0.8s ease-out 0.4s both",
                    textShadow: isLightOn
                        ? '29px 26px 9px #0c2033'
                        : '',
                    transition: 'text-shadow 0.3s ease'
                }}
            >
                Hi, I'm Peter Kirsch Madrid <br /> Full Stack Developer
            </div>
            <div className="text-center mb-4 lg:p-4 text-[#94a3b8]" style={{
                animation: "slideInUp 0.8s ease-out 0.6s both",
                textShadow: isLightOn
                    ? '29px 26px 9px #0c2033'
                    : '',
                transition: 'text-shadow 0.3s ease'
            }}>I craft exceptional digital experiences through innovative web solutions, combining cutting-edge technology with thoughtful design to bring ideas to life.</div>
